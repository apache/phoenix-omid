...
public class SnapshotFilter {
    ...
    private static Logger LOG = LoggerFactory.getLogger(SnapshotFilter.class);

    private TableAccessWrapper tableAccessWrapper;

    private CommitTable.Client commitTableClient;
    
    public SnapshotFilter(TableAccessWrapper tableAccessWrapper, CommitTable.Client commitTableClient) throws IOException {
        this.tableAccessWrapper = tableAccessWrapper;
        this.commitTableClient = commitTableClient;
    }

    public SnapshotFilter(TableAccessWrapper tableAccessWrapper) throws IOException {
