...
public class TestRowShadowCells extends OmidTestBase {
    ...
    public void testShadowCellsBasics(ITestContext context) throws Exception {
        ...
        assertFalse(hasShadowCell(row, family, SHARED_FAMILY_QUALIFIER, t1.getStartTimestamp(), new TTableCellGetterAdapter(table)),
        ...
        assertTrue(hasCell(row, family, qualifier, t1.getStartTimestamp(), new TTableCellGetterAdapter(table)),
                "Cell should be there");
        assertTrue(hasShadowCell(row, family, SHARED_FAMILY_QUALIFIER, t1.getStartTimestamp(), new TTableCellGetterAdapter(table)),
    ...
    public void testTransactionNeverCompletesWhenAnExceptionIsThrownUpdatingShadowCells(ITestContext context)
        ...
        assertTrue(hasCell(row, family, qualifier, tx.getStartTimestamp(), new TTableCellGetterAdapter(table)),
                "Cell should be there");
        assertFalse(hasShadowCell(row, family, SHARED_FAMILY_QUALIFIER, tx.getStartTimestamp(), new TTableCellGetterAdapter(table)),
                "Shadow cell should not be there");
    ...
    public void testRaceConditionBetweenReaderAndWriterThreads(final ITestContext context) throws Exception {
        ...
        AbstractTransactionManager tm = (AbstractTransactionManager) newTransactionManager(context,
                syncPostCommitter, HBaseTransactionManager.ConflictDetectionLevel.ROW);
    ...
    public void testGetOldShadowCells(ITestContext context) throws Exception {
        ...
        del.addColumn(family, CellUtils.addShadowCellSuffixPrefix(SHARED_FAMILY_QUALIFIER));
        htable.delete(del);
        table.flushCommits();
        ...
        put.addColumn(family,
                addLegacyShadowCellSuffix(SHARED_FAMILY_QUALIFIER),
